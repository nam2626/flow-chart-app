...
- [ ] T004 [P] Configure naming convention checks and review checklist
...
- [ ] T011 Define UX consistency checklist and shared copy rules
- [ ] T012 Define performance budget measurement baseline
...
> 테스트를 먼저 작성하고 실패를 확인한 뒤 구현을 시작한다.

- [ ] T013 [P] [US1] Unit test for [module] in tests/unit/test_[name].py
- [ ] T014 [P] [US1] Integration/E2E test for [user journey] in tests/integration/test_[name].py
...
- [ ] T021 [US1] Apply Korean rationale comments where needed
...
- [ ] T022 [P] [US2] Unit test for [module] in tests/unit/test_[name].py
- [ ] T023 [P] [US2] Integration/E2E test for [user journey] in tests/integration/test_[name].py
...
- [ ] T028 [P] [US3] Unit test for [module] in tests/unit/test_[name].py
- [ ] T029 [P] [US3] Integration/E2E test for [user journey] in tests/integration/test_[name].py
...
- [ ] TXXX UX consistency regression pass
- [ ] TXXX [P] Additional unit/integration tests
...
Task: "Unit test for [module] in tests/unit/test_[name].py"
Task: "Integration/E2E test for [user journey] in tests/integration/test_[name].py"
